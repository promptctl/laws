...
never saw — a criterion the agent cannot iterate against, which is what gives the suite
headroom over agents that saturate every visible gate. Every injected defect was
