...
1. Invoke Skill(laws:prompt) and read its references/craft.md as that skill instructs. Invoke no other skill. {{BLINDNESS}} Read nothing under .claude/skills/distill/ or evals/ except the specification.
