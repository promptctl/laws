...
The hooks write only under your temp directory, and only for the session at hand - the
lock directories that record which crafts are engaged. Nothing of theirs persists, so there
is nothing of theirs to clean up.
